...
const (
	STARTED StatusResponse_State = 0
	STOPPED StatusResponse_State = 1
	UNKNOWN StatusResponse_State = 2
)
...
func (m *StatusResponse) GetStatus() StatusResponse_State {
	if m != nil {
		return m.Status
	}
	return STARTED
...
func init() {
	...
	proto.RegisterEnum("messages.StatusResponse_State", StatusResponse_State_name, StatusResponse_State_value)
...
var fileDescriptor_4dc296cbfe5ffcd5 = []byte{
	...
	,
}
...
func (x StatusResponse_State) String() string {
	s, ok := StatusResponse_State_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= StatusResponse_State(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
